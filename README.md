...
session, consulte les articles et permet de consulter ou créer les catégories.
La modification et l'archivage des catégories, la gestion des articles ainsi que
la connexion de l'application React restent à implémenter.
